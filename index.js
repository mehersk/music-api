...
app.use((req, res, next) => {
    res.header("Access-Control-Allow-Origin", ["http://localhost:4200", "https://music-angular.herokuapp.com/"]); // update to match the domain you will make the request from
